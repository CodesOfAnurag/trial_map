    ...
    def create_map(self):
        ...
        for i, row in self.filtered_df.iterrows():
            ...
            <div style="width:200px;">
                ...
                <b>Route:</b> <a href="https://www.google.com/maps/dir/?api=1&origin={self.user_location[0]},{self.user_location[1]}&destination={row['latitude']},{row['longitude']}&travelmode=driving" target="_blank">View Route on Google Maps</a><br>
            </div>
            """
